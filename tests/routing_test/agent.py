...
# ---------------------------------------------------------------------------
# NOTE: The idea is to test the root_agent orchestrator prompt.
#       Therefore here the sub agents are mocked 
#       (some of the originals uses some API calls).
#       The orchestrator prompt has been tested here 
#       (with direction to use the mock tool instead of the sub agents)
# ---------------------------------------------------------------------------
